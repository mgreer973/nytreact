...
/***/ function(module, exports, __webpack_require__) {
	...
	// Grabs the Routes
	var routes = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = __webpack_require__(233);
		...
		render: function render() {
			...
			if (this.state.savedArticles == "") {
				...
				articles = this.state.savedArticles.map(function (article, index) {
					...
					return React.createElement('div', { key: index }, React.createElement('li', { className: 'list-group-item' }, React.createElement('h3', null, React.createElement('span', null, React.createElement('em', null, article.title)), React.createElement('span', { className: 'btn-group pull-right' }, React.createElement('a', { href: article.url, target: '_blank' }, React.createElement('button', { className: 'btn btn-default ' }, 'View Article')), React.createElement('button', { className: 'btn btn-primary', onClick: this.handleClick.bind(this, article) }, 'Delete'))), React.createElement('p', null, 'Date Published: ', article.date)));
				}.bind(this));
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		getSaved: function getSaved() {
			return axios.get('/api/saved').then(function (results) {
				console.log("getSaved axios results", results);
				return results;
			});
		},
	...
	// We export the helpers function (which contains)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Results = __webpack_require__(255);
		...
		render: function render() {
			...
			// If data is provided
					...
					articles = this.props.results.docs.map(function (article, index) {
						return React.createElement('div', { key: index }, React.createElement('li', { className: 'list-group-item' }, React.createElement('h3', null, React.createElement('span', null, React.createElement('em', null, article.headline.main)), React.createElement('span', { className: 'btn-group pull-right' }, React.createElement('a', { href: article.web_url, target: '_blank' }, React.createElement('button', { className: 'btn btn-default ' }, 'View Article')), React.createElement('button', { className: 'btn btn-primary', onClick: this.handleClick.bind(this, article), 'data-toggle': 'modal', 'data-target': '#myModal' }, 'Save'))), React.createElement('p', null, 'Date Published: ', article.pub_date)));
					}.bind(this));
				}
